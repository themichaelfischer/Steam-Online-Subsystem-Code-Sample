...
AWeapon::AWeapon()
{
	...
	// Disable collision for weapon pickup, on begin play enable it only for server
...
{
	AUdemy_MultiplayerCharacter* BlasterCharacter = Cast<AUdemy_MultiplayerCharacter>(OtherActor);
	if (BlasterCharacter)
	{
